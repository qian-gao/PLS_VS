...
%
% INPUT
% X        Array of independant variables
% Y1       Array of dependent variables representing group infomation 
% Y2       Array of dependant variables representing time information
...
function [Vsel]=BTVip(Xc,Yc,Fac,btnr,btmd);
...
switch btmd
    ...
    case 2 % choose random samples from different classes for bootstrap
        ugroup=unique(Group);
        n=[1:1:Ic]';
        Ind1=n(find(Group==ugroup(1)));
        Ind2=n(find(Group==ugroup(2)));
        I1=size(Ind1,1);
        I2=size(Ind2,1);
