function [XValResult,Model]=CV(X,y,MaxFac,Centering,CVmethod);
...
% CVmethod  : [Method, Number of segments, How segments be chosen] e.g. [2,10,1]
%             1 Leave one out; 2 K-fold: 1, '111222333...' 2, '123123123...' 3, 'Random' 
%             (For leave one out, no need to specify number of segments)
%
% OPTIONAL INPUT
...
% if exist('SegmentsID')~=1
    SegmentsID = MakeSegments(I,CVmethod);
% end
...
function SegmentsID = MakeSegments(I,CVmethod);
